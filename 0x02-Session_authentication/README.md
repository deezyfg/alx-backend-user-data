...
This project focuses on implementing session authentication in a backend API using Python and Flask, building upon the previous [basic authentication](https://github.com/deezyfg/alx-backend-user-data/tree/master/0x01-Basic_authentication) project to add session-based user authentication. It covers creating a SessionAuth class, managing user sessions with cookies, updating API endpoints to work with session auth, understanding authentication mechanisms, handling HTTP cookies, and implementing user retrieval endpoints while adhering to specific coding standards and documentation requirements.
...
Copy all your work of the [0x01. Basic authentication](https://github.com/deezyfg/alx-backend-user-data/tree/master/0x01-Basic_authentication) project in this new folder.
...
**Repo:**
  ...
  - GitHub repository: `alx-backend-user-data`
  - Directory: `0x02-Session_authentication`
  - File: [api/v1/auth/session_db_auth.py](api/v1/auth/session_db_auth.py), [api/v1/app.py](api/v1/app.py), [models/user_session.py](models/user_session.py)